  ...
  const html = `
    <div style="padding:40px; font-family:var(--font-body); color: #fff;">
      ...
      <table class="report-table" style="width:100%; border-collapse: collapse; margin-bottom: 25px;">
        <thead><tr><th style="width:15%">FECHA</th><th style="width:30%">OPERACION</th><th style="width:35%">TALLER/COMERCIO</th><th style="width:10%">KMS</th><th style="width:10%">COSTE</th></tr></thead>
      ...
      <table class="report-table" style="width:100%; border-collapse: collapse; margin-bottom: 25px;">
        <thead><tr><th style="width:15%">FECHA</th><th style="width:30%">AVERÍA/SÍNTOMA</th><th style="width:35%">TALLER/COMERCIO</th><th style="width:10%">KMS</th><th style="width:10%">COSTE</th></tr></thead>
      ...
      <table class="report-table" style="width:100%; border-collapse: collapse;">
        <thead><tr><th style="width:15%">FECHA</th><th style="width:30%">PIEZA/ARTÍCULO</th><th style="width:35%">TIENDA</th><th style="width:10%">KMS</th><th style="width:10%">COSTE</th></tr></thead>
